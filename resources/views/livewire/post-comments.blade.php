<div class="mt-10 comments-box border-t border-gray-100 pt-10">
    <h2 class="text-2xl font-semibold text-gray-900 mb-5">Keskustelu</h2>
    @auth
    ...
    @else
        <a wire:navigate class="text-blue-500 underline py-1" href="{{ route('login') }}"> Kirjaudu sisään osallistuaksesi
            keskusteluun</a>
    @endauth
