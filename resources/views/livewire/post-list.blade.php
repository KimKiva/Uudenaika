        ...
        <div class="text-blue-600">
            @if ($this->activeCategory || $search)
                <button wire:click="clearFilters()"
                    class="p-2 rounded-full bg-red-100 hover:bg-red-300 text-red-600 transition mr-3"
                    title="Tyhjennä suodattimet">
                    <!-- Heroicons: Trash (24x24) -->
            ...
            @if ($this->activeCategory)
                <x-badge href="{{ route('posts.index', ['category' => $this->activeCategory->slug]) }}"
