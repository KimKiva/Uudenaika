<x-app-layout title="Kotisivu">
    @section('angel')
        <div class="w-full text-center py-32">
            ...
            <div id="angelcard" class="relative mt-5 text-center hidden bg-blue-100 p-5 rounded-lg shadow-lg w-64 mx-auto">
                <!-- Sulkupainike -->
                <button onclick="closeAngelCard()"
                    class="absolute top-2 right-2 text-gray-500 hover:text-red-600 font-extrabold text-2xl leading-none">
                    &times;
                </button>

                <img id="angel-image" width="200" height="100" src=""
